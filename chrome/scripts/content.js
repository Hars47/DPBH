...
function sendResults() {
    ...
    //This part gives some error in meesho e-comm website->[Uncaught (in promise) Error: Extension context invalidated]
...
function highlightWords() {
    const wordsToHighlight = ["Only Few Left"];
  ...
  // Execute the highlighting function when the page loads
  highlightWords();
  
  // Listen for changes in the DOM (e.g., page navigation) and re-highlight
